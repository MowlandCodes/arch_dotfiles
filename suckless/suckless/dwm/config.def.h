...
#endif                                 // SWALLOW_PATCH
#endif                                 // RIODRAW_PATCH
/* Status is to be shown on: -1 (all monitors), 0 (a specific monitor by
...
static const unsigned int tabcyclekey = 0x17; /* (Tab) when this key is hit the menu moves one position forward
                                                 in client stack. Must be the same key as used to run alttabstart
                                               */
...
static char normbgcolor[]     = "#1B1B29";
static char normbordercolor[] = "#444444";
static char normfloatcolor[]  = "#C6A0F6";

static char selfgcolor[]     = "#eeeeee";
static char selbgcolor[]     = "#1B1B29";
static char selbordercolor[] = "#C6A0F6";
static char selfloatcolor[]  = "#C6A0F6";

static char titlenormfgcolor[]     = "#aaaaaa";
static char titlenormbgcolor[]     = "#1b1b29";
static char titlenormbordercolor[] = "#444444";
static char titlenormfloatcolor[]  = "#C6A0F6";

static char titleselfgcolor[]     = "#eeeeee";
static char titleselbgcolor[]     = "#212233";
static char titleselbordercolor[] = "#C6A0F6";
static char titleselfloatcolor[]  = "#C6A0F6";

static char tagsnormfgcolor[]     = "#aaaaaa";
static char tagsnormbgcolor[]     = "#1b1b29";
static char tagsnormbordercolor[] = "#444444";
static char tagsnormfloatcolor[]  = "#C6A0F6";

static char tagsselfgcolor[]     = "#1b1b29";
static char tagsselbgcolor[]     = "#C6A0F6";
 ...
 * bit different which has some added benefits. If you need to change the
 * number of tags here then change the NUMTAGS macro in dwm.c.
 *
 * Examples:
 *
 ...
 * matches. Similarly if there are two tag icons then it would alternate
 * between them. This works seamlessly with alternative tags and
 * alttagsdecoration patches.
 */
#if NAMETAG_PATCH
 ...
 *
 * The RULE macro has the default values set for each field allowing you to
 * only specify the values that are relevant for your rule, e.g.
 *
 ...
 * clickfunc                hoverfunc                name */
...
#if BAR_EXTRASTATUS_PATCH
#if BAR_STATUSCOLORS_PATCH && BAR_STATUSCMD_PATCH
    {statusmon, 1, BAR_ALIGN_CENTER,      width_statuscolors_es,   draw_statuscolors_es,   click_statuscmd_es,      NULL,
                              "statuscolors_es"                                                                                                                               },
#elif BAR_STATUSCOLORS_PATCH
    {statusmon, 1, BAR_ALIGN_CENTER, width_statuscolors_es, draw_statuscolors_es, click_statuscolors, NULL,
     "statuscolors_es"},
#elif BAR_STATUS2D_PATCH && BAR_STATUSCMD_PATCH
...
#elif BAR_POWERLINE_STATUS_PATCH
    {statusmon, 1, BAR_ALIGN_RIGHT, width_pwrl_status_es, draw_pwrl_status_es, click_pwrl_status, NULL,
     "powerline_status"},
    ...
    {-1,        1, BAR_ALIGN_RIGHT_RIGHT, width_wintitle_hidden,   draw_wintitle_hidden,   click_wintitle_hidden,   NULL,
                              "wintitle_hidden"                                                                                                                               },
#endif
#if BAR_WINTITLE_FLOATING_PATCH
    {-1,        1, BAR_ALIGN_LEFT,        width_wintitle_floating, draw_wintitle_floating, click_wintitle_floating, NULL,
                              "wintitle_floating"                                                                                                                             },
 ...
 */
    ...
    {ControlMask | ShiftMask,          XK_space,                 spawn,
                      SHCMD("$HOME/.local/bin/statusbar/sb-locale-switcher; kill -39 $(pidof dwmblocks)")                                                                               },
...
#if SHIFTBOTH_PATCH
    {MODKEY | ControlMask,             XK_Left,                  shiftboth,              {.i = -1}                                                                     }, // note keybinding conflict with focusadjacenttag
                                                            // tagandviewtoleft placedir
    {MODKEY | ControlMask,             XK_Right,                 shiftboth,              {.i = +1}                                                                     }, // note keybinding conflict with focusadjacenttag
